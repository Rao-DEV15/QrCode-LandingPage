...
const Hero = ({ onCreateClick }) => {
  ...
  return (
    <>
      <Helmet>
        <title>QrCode Quick – Create Free QR Codes in Seconds</title>
        <meta
          name="description"
          content="Build interactive digital experiences with QrCode Quick. Create custom QR codes for links, Wi-Fi, contact info, and payments in just seconds."
        />
        <meta
          name="keywords"
          content="QR codes, QR generator, create QR, Wi-Fi QR, contact QR, free QR code"
        />
      </Helmet>
