...
const InsightsSection = () => {
  useEffect(() => {
    document.title =
      "QR Code Tips & Ideas | QrCode Quick – Marketing & Business Uses";

    const metaDescription = document.createElement("meta");
    metaDescription.name = "description";
    metaDescription.content =
      "Quick tips and ideas for using QR codes in marketing, events, restaurants, and personal branding – by QrCode Quick.";
